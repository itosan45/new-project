...
export const STAGE_DEFINITIONS: StageDefinition[] = [
  ...
  },
  {
    ...
    pitfall:
      "「やること」だけ書いて出す。書かれていない作業は、後から必ず無償で降ってくる。もう1つは、指摘を記録せずに版だけ重ねて、同じ指摘を二度受けること。見た目の話をモック無しで言葉だけで進めるのも、ここで必ず食い違う。",
    repeats: {
      unit: "提案1版",
      ...
      round: [
        ...
        { phase: "前", who: "あなた", work: "金額と線引きを決める。出す前に必ず見る" },
        {
          phase: "前",
          who: "秘書",
          work: "モックを画像とPDFに書き出す。URLやHTMLでは渡さない",
        },
